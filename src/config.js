...
export const TUNING={step:1/120,jog:5.8,jogPaceRef:8.3,jogPaceShare:.25,sprint:8.6,acceleration:14,deceleration:19,turn:7,pass:16,shotMin:19,shotMax:34,rollResistance:.8,rollDamping:.2,turfFriction:.5,turfRestitution:.62,airDensity:1.225,dragCoefficient:.25,liftCoefficientMax:.35,controlRadius:.78,tackleRange:1.25,tackleCooldown:1.1,aiInterval:.16,staminaDrain:.065,staminaRecovery:.033};
