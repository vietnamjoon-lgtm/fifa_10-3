...
const factors={pace:10,acceleration:5,reach:100/2.1,height:100,build:100};
export const ratingLabels={pace:'속력',acceleration:'가속력',agility:'민첩성',balance:'균형감각',control:'볼 컨트롤',passing:'짧은 패스',longPass:'긴 패스',shooting:'골결정력',power:'슛 파워',tackling:'태클',strength:'몸싸움',reflexes:'GK 반응',reach:'GK 도달 범위',weakFoot:'약한 발'};
