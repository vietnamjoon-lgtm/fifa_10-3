...
export const defaults={...assistanceDefaults,gameplay:gameplayDefaults,quality:'high',camera:0,volume:.5,sound:false,halfSeconds:120,difficulty:'normal',userTeam:0,deadzone:.15,sensitivity:1,shadows:true,crowd:true,scale:1,helpers:true,controls:'online',defence:'basic',homeClub:DEFAULT_CLUBS.home,awayClub:DEFAULT_CLUBS.away};
