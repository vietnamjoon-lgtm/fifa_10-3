...
export function createPlayer(team=0,number=10,keeper=false,profile={}){
  ...
  label(torso,textMat('APEX',team===0?'#173b27':'#fff',undefined,70,128),0,.34,.190,.30,.115);
  label(torso,textMat(team===0?'A':'V',team===0?'#153b24':'#f5e9d5',undefined,120),.12,.46,.16,.065,.075);
  label(torso,textMat(String(number),team===0?'#183b27':'#fff'),0,.31,-.190,.34,.34,Math.PI);
  label(torso,textMat(profile.name||(team===0?'APEX FC':'VOLT UNITED'),team===0?'#183b27':'#fff',undefined,41,96),0,.47,-.16,.31,.09,Math.PI);
