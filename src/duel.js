...
export function matchSnapshot(m){
 ...
 return {time:round(m.time),state:m.state,half:m.half,elapsed:round(m.elapsed),timer:round(m.timer),score:m.score,stats:m.stats,goalTeam:m.goalTeam,
  ...
  advantage:!!m.advantage,addedTime:m.addedTime,setPiece:m.setPiece?{kind:m.setPiece.kind,team:m.setPiece.team,taker:m.setPiece.taker.id,label:m.setPiece.label,style:m.setPiece.style,aimZ:m.setPiece.aimZ,aimHeight:m.setPiece.aimHeight}:null,
