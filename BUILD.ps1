...
$names = @('index.html','style.css','package.json','server.mjs','PLAY.cmd','README.md','COLLABORATION.md','CLAUDE.md','.gitignore','.github','BUILD.ps1','vercel.json','.vercelignore','src','assets-source','vendor','tools','licenses','tests','reports','screenshots','server/worker.js','server/room.js','server/wrangler.jsonc')
